 ...
 * @author HP
 */
public class CrearReporteFechaHilo implements Runnable {
    ...
    public CrearReporteFechaHilo(String fechaU, String fechaD, String cod) {
    ...
    public void run() {
        ...
        try {
            ...
            String query = "SELECT reportes.id_rep, reportes.cod_emp2, reportes.horaEntrada,"
                    ...
                    + "WHERE (reportes.fecha BETWEEN '" + fechaU + "' AND '" + fechaD + "') AND reportes.cod_emp2 = '" + cod + "'";
