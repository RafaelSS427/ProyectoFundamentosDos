 ...
 * @author HP
 */
public class CrearReporteFechaAdminHilo implements Runnable {

    private Conexion conexion;
    private String fechaU;
    private String fechaD;

    public CrearReporteFechaAdminHilo(String fechaU, String fechaD) {
    ...
    public void run() {
        ...
        try {
            ...
            String query = "SELECT reportes.id_rep, reportes.cod_emp2, reportes.horaEntrada,"
                    ...
                    + "WHERE reportes.fecha BETWEEN '" + fechaU + "' AND '" + fechaD + "'";
